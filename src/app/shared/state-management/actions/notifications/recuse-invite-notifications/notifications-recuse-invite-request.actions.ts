...
export class RecuseInviteNotificationsRequest implements CustomAction<UserNotificationsSuccess> {
    readonly type: string = NotificationsEnum.LOAD_NOTIFICATIONS_RECUSE_INVITE_REQUEST;
