...
export class PostCommentsCreateSuccessAction implements CustomAction<LoadCommentsSuccess> {
    readonly type: string = FeedMessageEnum.LOAD_CREATE_COMMENTS_POST_SUCCESS;
